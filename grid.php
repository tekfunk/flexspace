...
<?php include('inc/header.php'); ?>
    <section class="hero">
        <div class="container">
            <h1>grid</h1>
            <h3><a href="#columns">columns</a> | <a href="#tiles">tiles</a> | <a href="#tables">tables</a> </h3>
        </div>
    </section>
    <section class="section" id="columns">
        <div class="container">
            <h1>.columns</h1>
            <h4>.columns -&gt; .column</h4>
            <hr>
              <div class="columns">
                <div class="column">
...
<span class="nt">&lt;/div&gt;</span></code>
            ...
            <div class="columns is-mobile">
                <div class="column is-half-mobile is-one-third-tablet is-one-quarter-desktop">
                    <p class="notification is-info"><code>is-half-mobile</code><br>
                    <code>is-one-third-tablet</code><br>
                    <code>is-one-quarter-desktop</code></p>
                </div>
                <div class="column">
