...
<section class="hero">
  <div class="container is-fluid">
    <h1>page</h1>
    <h2>body -> header .hero section footer -> .container -> .content</h2>
  </div>
</section>
<section class="section">
  <div class="container">
    <h1 class="title">header section figure footer</h1>
    <hr>
  </div>
</section>  
<header>  
...
<section class="hero">  
    <div class="notification">section .hero</div>
</section>
<section>  
    <div class="notification">section</div>
</section>
<section class="section">  
    <div class="notification">section .section</div>
</section>
<figure>
	  <div class="notification">figure</div>
</figure>
<footer>   
