...
<section class="section">
	<div class="container">
    <h1 class="title">Icons</h1>
    <h2 class="subtitle">My custom font for icons</h2>
			<div class="columns">

        <div class="glyph card tile is-parent">
